 ...
 */
final class Version20230329135645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE desks (id INT AUTO_INCREMENT NOT NULL, owners_id INT DEFAULT NULL, status_desks_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, adress VARCHAR(50) NOT NULL, city VARCHAR(50) NOT NULL, zip_code VARCHAR(25) NOT NULL, description VARCHAR(255) NOT NULL, number_places INT NOT NULL, INDEX IDX_BFDA6542236ECBFC (owners_id), INDEX IDX_BFDA6542F6099FD1 (status_desks_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
